    ...
    <div className="p-4 md:p-8 space-y-6 max-w-6xl mx-auto pb-20">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Gestión de encargados, sucursales, firmas y seguridad.</p>
        </div>
      ...
      <Tabs defaultValue="pines" className="w-full">
        <TabsList className="w-full h-auto flex-wrap gap-1 p-1 mb-6">
          <TabsTrigger value="pines" className="flex-1 min-w-[120px] gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
            <Users className="w-4 h-4" /> PINs
          </TabsTrigger>
          <TabsTrigger value="api" className="flex-1 min-w-[120px] gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
            <Network className="w-4 h-4" /> API
          </TabsTrigger>
          <TabsTrigger value="sedes" className="flex-1 min-w-[120px] gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
            <Store className="w-4 h-4" /> Sedes
          </TabsTrigger>
          <TabsTrigger value="firmas" className="flex-1 min-w-[120px] gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
            <FileSignature className="w-4 h-4" /> Firmas
          </TabsTrigger>
          <TabsTrigger value="empresa" className="flex-1 min-w-[120px] gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
            <Globe className="w-4 h-4" /> Empresa
          </TabsTrigger>
        </TabsList>

        {/* TAB: PINs y Empleados */}
        <TabsContent value="pines" className="space-y-6 mt-0">
        ...
        <TabsContent value="api" className="space-y-6 mt-0">
          <Card className="border-2">
            <CardHeader>
              <CardTitle className="font-headline flex items-center gap-2 text-xl">
                <Network className="w-5 h-5" /> Conectividad y APIs
              </CardTitle>
        ...
        <TabsContent value="sedes" className="space-y-6 mt-0">
          <Card className="border-2">
            <CardHeader>
              <CardTitle className="font-headline flex items-center gap-2 text-xl">
                <Store className="w-5 h-5" /> Sedes Operativas
              </CardTitle>
            </CardHeader>
        ...
        {/* TAB: Firmas Autorizadas */}
        <TabsContent value="firmas" className="space-y-6 mt-0">
          <FirmasAutorizadasCard />
        </TabsContent>
